...
class GeneticAlgorithm:
    def __init__(self, vehicles, locations, shifts=6, population_size=200, generations=150, rest_period=10, patrol_time=5, heuristic_file='AHBPS_Run_Time_Large_Instance.txt'):
...
results_filename = 'GDVPS_Run_Time_Large_Instance.txt'
