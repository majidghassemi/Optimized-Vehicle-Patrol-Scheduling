...
class HVSP:
    ...
    def main(self):
        ...
        rest_periods = [5, 15]  # List of rest periods to test
        ...
        for rest_time in rest_periods:
            for vehicles, locations in test_cases:
                ...
                self.rest_period = rest_time  # Update the rest period
                ...
                self.write_results_to_file('AHBPS_diff_rest.txt', self.vehicles, self.shifts, self.total_locations, self.rest_period, average_unique, average_total, execution_time)
