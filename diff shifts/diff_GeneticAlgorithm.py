...
class GeneticAlgorithm:
    def __init__(self, vehicles, locations, shifts=6, population_size=200, generations=150, rest_period=10, patrol_time=5, heuristic_file='/home/ubuntu/Optimized-Vehicle-Patrol-Scheduling/AHBPS_diff_shifts.txt'):
    ...
    def initialize_population(self):
        ...
        if heuristic_key in self.heuristic_solutions:
...
results_filename = 'GDVPS_diff_shifts.txt'
...
for vehicles, locations in VALID_PAIRS:
    for shifts in range(1, 7):  # Loop through shifts from 1 to 6
        ...
        print(f"Details for {vehicles} vehicles and {locations} locations with {shifts} shifts:")
