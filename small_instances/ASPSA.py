...
class HVSP:
    ...
    def main(self):
        ...
        for vehicles, locations in test_cases:
            ...
            self.write_results_to_file('AHBPS_Small_Instance_Execution_Time.txt', self.vehicles, self.shifts, self.total_locations, self.rest_period, average_unique, average_total, execution_time)
